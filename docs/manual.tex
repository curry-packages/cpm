...
\item[\fbox{\code{list [--all] [--versions] [--csv]}}]
List the names and synopses of all packages
(compatible to the current compiler) of the central package index.
The option \code{--all} shows all packages independent
of their compiler compatibility.
The option \code{--versions} shows also all versions of the packages.
The option \code{--csv} shows the information in CSV format.

\item[\fbox{\code{list --category [--all] [--csv]}}]
...
The options \code{--all} and \code{--csv} are as above.
