...
The most prominent library is the \code{Prelude}
...
there is a distinguished package \code{base} containing
these libraries.
...
\item[\fbox{\code{test [--modules $\mathit{modules}$] [--compile]}}]
