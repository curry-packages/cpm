...
It is also allowed that a package specification contains
more than one \code{executable} specification.
In this case, all the specified executables are installed by
the command \code{cypm install}.
