...
import Data.List   ( intercalate, intersect, nub, splitOn, isPrefixOf, isInfixOf
                   , find, delete, (\\), nubBy )
...
analyzeModules :: (Read a, Show a) => String -> Analysis a -> [String]
...
analyzeModule :: (Read a, Show a) => Analysis a -> [String] -> String
              -> IO (ProgInfo a)
